#CatchMe! the Heaven's Ruby
#Creator: Muhammad Razif Rizqullah (University of Lampung, Indonesia)
#Intepreter: python 2.x
#Copyright by: LinkGish
#CAUTION
    #this software is FREE to share or modify
    #Don't SELL this product, this is FREEWARE
...
def main():
    ...
    pygame.display.set_caption("CatchMe! the Heaven's Ruby")
    while True:
        gameplay_start()
...
def gameplay_HUMANvsAI():
    ...
    while True:
        ...
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                if pygame.Rect(10, WINDOWHEIGHT - Y_MENU-10,X_MENU, Y_MENU).collidepoint(mousex,mousey):
                    return
                elif pygame.Rect(WINDOWWIDTH - X_EXIT-10, WINDOWHEIGHT - Y_EXIT-10,X_EXIT, Y_EXIT).collidepoint(mousex,mousey):
                    terminate()

        if -25<playerACoord[A]['x']-enemyCoord[START]['x']<25 and -25<playerACoord[A]['y']-enemyCoord[START]['y']<25:
            enemyCoord = getRandomLocation()
            #pygame.time.delay(500)
            PLYRscore+=1
        if -25<botCoord[A]['x']-enemyCoord[START]['x']<25 and -25<botCoord[A]['y']-enemyCoord[START]['y']<25:
            BOTscore+=1
            #pygame.time.delay(500)
            enemyCoord = getRandomLocation()
        ...
        if playerACoord[A]['x']<25 or playerACoord[A]['x']>WINDOWWIDTH-25 or playerACoord[A]['y']<25 or playerACoord[A]['y']>WINDOWHEIGHT-25:
            move = STOP
        ...
        if ((enemyCoord[START]['x']<0) and (direction==UP)):
            ...
            direction = UP
    #AI program
        if direction==UP and botCoord[START]['x']>enemyCoord[START]['x'] and botCoord[START]['y']>enemyCoord[START]['y']:
            BOTmove = {'x':botCoord[START]['x']-n, 'y':botCoord[START]['y']}
        elif direction==UP and botCoord[START]['x']>enemyCoord[START]['x'] and botCoord[START]['y']<enemyCoord[START]['y']:
        ...
        elif direction==DOWN and botCoord[START]['x']>enemyCoord[START]['x'] and botCoord[START]['y']>enemyCoord[START]['y']:
            BOTmove = {'x':botCoord[START]['x'], 'y':botCoord[START]['y']-n}
        elif direction==DOWN and botCoord[START]['x']>enemyCoord[START]['x'] and botCoord[START]['y']<enemyCoord[START]['y']:
            BOTmove = {'x':botCoord[START]['x'], 'y':botCoord[START]['y']+n}
        elif direction==DOWN and botCoord[START]['x']<enemyCoord[START]['x'] and botCoord[START]['y']>enemyCoord[START]['y']:
        ...
        elif direction==LEFT and botCoord[START]['x']>enemyCoord[START]['x'] and botCoord[START]['y']>enemyCoord[START]['y']:
            BOTmove = {'x':botCoord[START]['x']-n, 'y':botCoord[START]['y']}
        elif direction==LEFT and botCoord[START]['x']>enemyCoord[START]['x'] and botCoord[START]['y']<enemyCoord[START]['y']:
            BOTmove = {'x':botCoord[START]['x']-n, 'y':botCoord[START]['y']}
        elif direction==LEFT and botCoord[START]['x']<enemyCoord[START]['x'] and botCoord[START]['y']>enemyCoord[START]['y']:
        ...
        elif direction==RIGHT and botCoord[START]['x']>enemyCoord[START]['x'] and botCoord[START]['y']>enemyCoord[START]['y']:
            BOTmove = {'x':botCoord[START]['x'], 'y':botCoord[START]['y']-n}
        elif direction==RIGHT and botCoord[START]['x']>enemyCoord[START]['x'] and botCoord[START]['y']<enemyCoord[START]['y']:
            BOTmove = {'x':botCoord[START]['x']-n, 'y':botCoord[START]['y']}
        elif direction==RIGHT and botCoord[START]['x']<enemyCoord[START]['x'] and botCoord[START]['y']>enemyCoord[START]['y']:
...
def gameplay_start():
    ...
    while True:
        ...
        textRect.topleft = (20,10)
        DISPLAYSURF.blit(textSurf,textRect)
        textSurf = FONT.render('version 1.10',True,BLACK)
        textRect = textSurf.get_rect()
        textRect.topleft = (20,20+textSurf.get_height())
        DISPLAYSURF.blit(textSurf,textRect)                

        if -25<botCoord[START]['x']-enemyCoord[START]['x']<25 and -25<botCoord[START]['y']-enemyCoord[START]['y']<25:
            BOTscore+=1
            enemyCoord = getRandomLocation()
        if -25<botCoord2[START]['x']-enemyCoord[START]['x']<25 and -25<botCoord2[START]['y']-enemyCoord[START]['y']<25:
            BOTscore2+=1
            enemyCoord = getRandomLocation()
        if -25<botCoord3[START]['x']-enemyCoord[START]['x']<25 and -25<botCoord3[START]['y']-enemyCoord[START]['y']<25:
            BOTscore3+=1
            enemyCoord = getRandomLocation()
    ...
    #2nd AI green
        if direction==UP and botCoord2[START]['x']>enemyCoord[START]['x'] and botCoord2[START]['y']>enemyCoord[START]['y']:
            BOTmove1 = {'x':botCoord2[START]['x']-n, 'y':botCoord2[START]['y']}
        elif direction==UP and botCoord2[START]['x']>enemyCoord[START]['x'] and botCoord2[START]['y']<enemyCoord[START]['y']:
            BOTmove1 = {'x':botCoord2[START]['x']-n, 'y':botCoord2[START]['y']}
        elif direction==UP and botCoord2[START]['x']<enemyCoord[START]['x'] and botCoord2[START]['y']>enemyCoord[START]['y']:
        ...
        elif direction==DOWN and botCoord2[START]['x']>enemyCoord[START]['x'] and botCoord2[START]['y']>enemyCoord[START]['y']:
            BOTmove1 = {'x':botCoord2[START]['x'], 'y':botCoord2[START]['y']-n}
        elif direction==DOWN and botCoord2[START]['x']>enemyCoord[START]['x'] and botCoord2[START]['y']<enemyCoord[START]['y']:
            BOTmove1 = {'x':botCoord2[START]['x'], 'y':botCoord2[START]['y']+n}
        elif direction==DOWN and botCoord2[START]['x']<enemyCoord[START]['x'] and botCoord2[START]['y']>enemyCoord[START]['y']:
        ...
        elif direction==LEFT and botCoord2[START]['x']>enemyCoord[START]['x'] and botCoord2[START]['y']>enemyCoord[START]['y']:
            BOTmove1 = {'x':botCoord2[START]['x'], 'y':botCoord2[START]['y']-n}
        elif direction==LEFT and botCoord2[START]['x']>enemyCoord[START]['x'] and botCoord2[START]['y']<enemyCoord[START]['y']:
            BOTmove1 = {'x':botCoord2[START]['x']-n, 'y':botCoord2[START]['y']}
        elif direction==LEFT and botCoord2[START]['x']<enemyCoord[START]['x'] and botCoord2[START]['y']>enemyCoord[START]['y']:
        ...
        elif direction==RIGHT and botCoord2[START]['x']>enemyCoord[START]['x'] and botCoord2[START]['y']>enemyCoord[START]['y']:
            BOTmove1 = {'x':botCoord2[START]['x'], 'y':botCoord2[START]['y']-n}
        elif direction==RIGHT and botCoord2[START]['x']>enemyCoord[START]['x'] and botCoord2[START]['y']<enemyCoord[START]['y']:
            BOTmove1 = {'x':botCoord2[START]['x']-n, 'y':botCoord2[START]['y']}
        elif direction==RIGHT and botCoord2[START]['x']<enemyCoord[START]['x'] and botCoord2[START]['y']>enemyCoord[START]['y']:
    ...
    #3rd AI blue
        if direction==UP and botCoord3[START]['x']>enemyCoord[START]['x'] and botCoord3[START]['y']>enemyCoord[START]['y']:
            BOTmove2 = {'x':botCoord3[START]['x']-n, 'y':botCoord3[START]['y']}
        elif direction==UP and botCoord3[START]['x']>enemyCoord[START]['x'] and botCoord3[START]['y']<enemyCoord[START]['y']:
        ...
        elif direction==DOWN and botCoord3[START]['x']>enemyCoord[START]['x'] and botCoord3[START]['y']>enemyCoord[START]['y']:
            BOTmove2 = {'x':botCoord3[START]['x'], 'y':botCoord3[START]['y']-n}
        elif direction==DOWN and botCoord3[START]['x']>enemyCoord[START]['x'] and botCoord3[START]['y']<enemyCoord[START]['y']:
            BOTmove2 = {'x':botCoord3[START]['x'], 'y':botCoord3[START]['y']+n}
        elif direction==DOWN and botCoord3[START]['x']<enemyCoord[START]['x'] and botCoord3[START]['y']>enemyCoord[START]['y']:
        ...
        elif direction==LEFT and botCoord3[START]['x']>enemyCoord[START]['x'] and botCoord3[START]['y']>enemyCoord[START]['y']:
            BOTmove2 = {'x':botCoord3[START]['x']-n, 'y':botCoord3[START]['y']}
        elif direction==LEFT and botCoord3[START]['x']>enemyCoord[START]['x'] and botCoord3[START]['y']<enemyCoord[START]['y']:
            BOTmove2 = {'x':botCoord3[START]['x']-n, 'y':botCoord3[START]['y']}
        elif direction==LEFT and botCoord3[START]['x']<enemyCoord[START]['x'] and botCoord3[START]['y']>enemyCoord[START]['y']:
        ...
        elif direction==RIGHT and botCoord3[START]['x']>enemyCoord[START]['x'] and botCoord3[START]['y']>enemyCoord[START]['y']:
            BOTmove2 = {'x':botCoord3[START]['x'], 'y':botCoord3[START]['y']-n}
        elif direction==RIGHT and botCoord3[START]['x']>enemyCoord[START]['x'] and botCoord3[START]['y']<enemyCoord[START]['y']:
            BOTmove2 = {'x':botCoord3[START]['x']-n, 'y':botCoord3[START]['y']}
        elif direction==RIGHT and botCoord3[START]['x']<enemyCoord[START]['x'] and botCoord3[START]['y']>enemyCoord[START]['y']:
...
def gameplay_HUMANvsHUMAN():
    ...
    while True:
        ...
        if -25<playerACoord[A]['x']-enemyCoord[START]['x']<25 and -25<playerACoord[A]['y']-enemyCoord[START]['y']<25:
            ...
            #pygame.time.delay(500)
            PLYRscore+=1
        elif -25<playerBCoord[B]['x']-enemyCoord[START]['x']<25 and -25<playerBCoord[B]['y']-enemyCoord[START]['y']<25:
            enemyCoord = getRandomLocation()
            #pygame.time.delay(500)
            PLYRscore2+=1
        ...
        if playerBCoord[B]['x']<25 or playerBCoord[B]['x']>WINDOWWIDTH-25 or playerBCoord[B]['y']<25 or playerBCoord[B]['y']>WINDOWHEIGHT-25:
            move2 = STOP
...
def key():
    for event in pygame.event.get():
        if event.type == QUIT:
            ...
            mousex,mousey = event.pos
            if pygame.Rect(WINDOWWIDTH - X_EXIT-10, WINDOWHEIGHT - Y_EXIT-10,X_EXIT, Y_EXIT).collidepoint(mousex,mousey):
                terminate()
            elif pygame.Rect(WINDOWWIDTH*5/8, WINDOWHEIGHT*5/8+Y_OPT2+10,X_OPT2, Y_OPT2).collidepoint(mousex,mousey):
                gameplay_HUMANsolo()
            elif pygame.Rect(WINDOWWIDTH*5/8, WINDOWHEIGHT*5/8+2*(Y_OPT3+10),X_OPT3, Y_OPT3).collidepoint(mousex,mousey):
                gameplay_HUMANvsAI()
            elif pygame.Rect(WINDOWWIDTH*5/8, WINDOWHEIGHT*5/8+3*(Y_OPT4+10),X_OPT4, Y_OPT4).collidepoint(mousex,mousey):
                gameplay_HUMANvsHUMAN()
            elif pygame.Rect(WINDOWWIDTH*5/8, WINDOWHEIGHT*5/8+4*(Y_OPT5+10),X_OPT5, Y_OPT5).collidepoint(mousex,mousey):
                gameplay_AIvsAIvsAI()
